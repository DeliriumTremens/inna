...
@Controller
@RequestMapping("inventory/local")
public class LocalInventoryController extends SinaiController {
	
  @RequestMapping("/setup.do")
  public String  setup(ModelMap model, @ModelAttribute Session session){
	model.addAttribute("types", getAllLocalInventoryTypes()); 
	return "inventory/local/main";
  }
