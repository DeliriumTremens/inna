...
@Controller
@RequestMapping("report/finances")
public class FinanceReportController extends SinaiController{
	
	
  @RequestMapping("/setup.do")
  public String  setup(ModelMap model){
	model.put("toSearch", new ReportSearch());
	return "report/finances/financeReport";
  }
  
  @RequestMapping("/search.do")
  public String  search(ModelMap model){
	return "report/finances/_chart";
  }
