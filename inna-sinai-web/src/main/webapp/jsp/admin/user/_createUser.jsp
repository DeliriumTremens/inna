...
<form:form  title="Agregar" modelAttribute="newMasterUser" id="newMasterUserForm" class="styledModalForm validableForm custom[width:745]" target="ajax:result" action="usersAdministration/create.do">
   <table>
        <tr>
