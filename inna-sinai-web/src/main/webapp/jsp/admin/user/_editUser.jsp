...
<form:form modelAttribute="masterUser" id="modalFormEditUser" class="styledModalForm custom[width:745]" title="Editar" target="ajax:result" action="usersAdministration/updateUserInformation.do">
