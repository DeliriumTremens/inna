...
<form:form  title="Agregar" modelAttribute="newRow" id="newRowForm" class="styledModalForm validableForm custom[width:570]" target="ajax:result" action="catalog/jobSpecs/create.do">
   <table>
        <tr>
